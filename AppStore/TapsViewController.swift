...
class TapsViewController: UIViewController {
  ...
  func createDataSource() {
    dataSource = UICollectionViewDiffableDataSource<Section, App>(collectionView: collectionView) { collectionView, indexPath, app in
      ...
      case "smallTable": return self.configure(SmallTableCell.self, wiht: app, for: indexPath)
      case "mediumTable": return self.configure(MediumTableCell.self, wiht: app, for: indexPath)
